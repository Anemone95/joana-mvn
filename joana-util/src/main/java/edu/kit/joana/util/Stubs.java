...
public enum Stubs {
	NO_STUBS         ("NONE",              null,                               JoanaConstants.nativesWala,  Stubs.class.getClassLoader()),
	JRE_14_INCOMPLETE("JRE_14_INCOMPLETE", "stubs/jSDG-stubs-jre1.4.jar",      JoanaConstants.nativesEmpty, Stubs.class.getClassLoader()),
	JRE_15_INCOMPLETE("JRE_15_INCOMPLETE", "stubs/jSDG-stubs-jre1.5.jar",      JoanaConstants.nativesEmpty, Stubs.class.getClassLoader()),
	JRE_15           ("JRE_15",            "stubs/jdk-1.5-with-stubs.jar",     JoanaConstants.nativesEmpty, Stubs.class.getClassLoader()),
	JRE_16           ("JRE_16",            "stubs/jdk-1.6-with-stubs.jar",     JoanaConstants.nativesEmpty, Stubs.class.getClassLoader()),
	JRE_17           ("JRE_17",            "stubs/jdk-1.7-with-stubs.jar",     JoanaConstants.nativesEmpty, Stubs.class.getClassLoader()),
	JAVACARD         ("JAVACARD",          "stubs/jSDG-stubs-javacard.jar"
	                                    + ":stubs/api.jar",                    JoanaConstants.nativesEmpty, Stubs.class.getClassLoader()),
	J2ME             ("J2ME",              "stubs/jSDG-stubs-j2me2.0.jar"
	                                    + ":stubs/jsr184.jar"
			                            + ":stubs/mmapi.jar",                  JoanaConstants.nativesEmpty, Stubs.class.getClassLoader());
	...
	private boolean locateableByClassLoader(final String name) {
		final URL urlStubsLocation = Stubs.class.getClassLoader().getResource(name);
